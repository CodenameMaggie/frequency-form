    ...
    <div className="pb-16">
      ...
      <section className="section-padding bg-[rgb(var(--color-muted))]">
        <div className="container max-w-4xl text-center">
          <h1 className="font-serif text-5xl md:text-6xl text-[rgb(var(--color-primary))] mb-6">
            The Science of Fabric Frequency
          </h1>
          <p className="text-xl text-[rgb(var(--color-text))] leading-relaxed">
      ...
      <section className="section-padding">
        <div className="container max-w-4xl">
          <h2 className="font-serif text-4xl text-[rgb(var(--color-primary))] mb-8 text-center">
            The Research
          </h2>

          <div className="space-y-6 text-lg text-[rgb(var(--color-text))] leading-relaxed">
            <p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-[rgb(var(--color-muted))]">
              <p className="text-sm tracking-wider uppercase text-[rgb(var(--color-text))] opacity-60 mb-2">
                Human Baseline
              </p>
              <p className="font-serif text-4xl text-[rgb(var(--color-text))] mb-2">100 Hz</p>
            ...
            <div className="text-center p-6 bg-[rgb(var(--color-muted))]">
              ...
              <p className="font-serif text-4xl text-[rgb(var(--color-accent))] mb-2">5,000 Hz</p>
              <p className="text-sm text-[rgb(var(--color-text))] opacity-70">
            ...
            <div className="text-center p-6 bg-[rgb(var(--color-muted))]">
              ...
              <p className="font-serif text-4xl text-[rgb(var(--color-never))] mb-2">15 Hz</p>
              <p className="text-sm text-[rgb(var(--color-text))] opacity-70">
                Same as synthetics
              </p>
            </div>
      ...
      {/* The Frequency Chart */}
      <section className="section-padding bg-[rgb(var(--color-muted))]" id="fabrics">
        <div className="container max-w-5xl">
          <h2 className="font-serif text-4xl text-[rgb(var(--color-primary))] mb-12 text-center">
            The Frequency Chart
          </h2>
      ...
      <section className="section-padding">
        <div className="container max-w-4xl">
          ...
          <div className="space-y-12">
            {/* Linen */}
            <div>
              <h3 className="font-serif text-2xl text-[rgb(var(--color-primary))] mb-4">
                <FabricTooltip fabricType="linen">Linen</FabricTooltip>
              </h3>
              <p className="text-lg text-[rgb(var(--color-text))] leading-relaxed mb-3">
      ...
      <section className="section-padding bg-[rgb(var(--color-primary))] text-[rgb(var(--color-background))]">
        <div className="container max-w-4xl text-center">
          <h2 className="font-serif text-4xl text-[rgb(var(--color-background))] mb-8">
            The Linen + Wool Rule
          </h2>
      ...
      {/* Our Standards */}
      <section className="section-padding bg-[rgb(var(--color-muted))]" id="standards">
        <div className="container max-w-4xl">
          <h2 className="font-serif text-4xl text-[rgb(var(--color-primary))] mb-12 text-center">
            Our Standards
          </h2>
