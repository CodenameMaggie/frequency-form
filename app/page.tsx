...
export default function HomePage() {
  return (
    <main className="min-h-screen">
        ...
        <div className="flex flex-col gap-[3px] mb-6">
          ...
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-[140px] bg-[#1e2a3a] p-6 md:py-6 md:px-5 flex flex-col justify-center text-center">
              <span className="font-serif text-[26px] font-light text-[#c9a0a0] mb-0.5">0–15 Hz</span>
              <span className="font-sans text-[8px] tracking-[0.25em] uppercase font-medium text-[#c9a0a0]">Depleting</span>
            </div>
            <div className="flex-1 bg-[#1e2a3a] p-6 md:py-6 md:px-7 flex flex-col justify-center">
              <h3 className="font-serif text-lg font-normal mb-1.5 tracking-[0.05em] text-[#faf8f4]">What We Never Carry</h3>
              <p className="font-sans text-[13px] font-light mb-2 text-[#a08080] line-through decoration-[#806060]">Polyester · Nylon · Acrylic · Rayon</p>
              <p className="font-sans text-xs font-light italic text-[#c9a0a0]">The same frequency as diseased tissue. We believe you deserve better.</p>
            </div>
          </div>
      ...
      {/* The Promise Section */}
      <section className="text-center py-[50px] px-6 bg-[#f5f0e4] mb-[70px]">
        <p className="font-sans text-[9px] tracking-[0.4em] uppercase text-[#b8a888] font-medium mb-3">
          Our Promise
        </p>
        ...
        <p className="font-serif text-[13px] italic text-[#1e2a3a] max-w-[400px] mx-auto">
      ...
      <section className="text-center max-w-[420px] mx-auto px-6 pb-20">
        ...
        <h2 className="font-serif text-[28px] font-light text-[#1e2a3a] mb-3 tracking-[0.05em]">
